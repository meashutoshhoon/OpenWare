...
import in.afi.codekosh.components.DeviceName.DeviceInfo;
...
public class DeviceDatabase extends SQLiteOpenHelper {
    ...
    public String query(String codename, String model) {
    ...
    //@SuppressWarnings("WeakerAccess")
    public DeviceInfo queryToDevice(String codename, String model) {
        SQLiteDatabase database = getReadableDatabase();
