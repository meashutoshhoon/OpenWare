...
public class LoadingDialog {
    ...
    public void show(String text) {
        if (coreProgress == null) {
            ...
            coreProgress.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        }

        coreProgress.show();
        coreProgress.setContentView(R.layout.loading_diloag);
        ...
        TextView textView = coreProgress.findViewById(R.id.text);
